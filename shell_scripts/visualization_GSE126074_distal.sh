...
if false; then
Catactor --update --norm --top-genes 2000 --cfilter genome_flag --gene-name '' --clabel global_index_5000 --cindex global_index --rindex local_index --rlabel '' --verbose \
	...
	--output ${GSE}_${dist} preprocess ${GSE}_sparse_mat_AdCortex.mtx
break
else
Catactor  --pca 8 --norm --tsne-params nn=15,perplexity=100,learning_rate=1000  --cfilter genome_flag --clabel $clabel --cindex global_index --rindex local_index --rlabel '' --verbose \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --adir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} \
	--row ${GSE}_cell_ng_AdCortex_meta.csv --skip 2 \
	--column ${GSE}_bin_ng_AdCortex_with_bins_annot.csv \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --mdir $mdir --markers $marker_file --cluster cluster,cluster_leiden,cluster_louvain,Ident,celltype \
